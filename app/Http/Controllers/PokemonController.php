...
class PokemonController extends Controller
{
    ...
    {
        $pokemons = $searchPokemonAction->searchPokemon($request->toPokemonSearchDTO());
        $pokemonExist=$pokemons->pokemonExist ? '' : 'no record data with name "'.$request->toPokemonSearchDTO()->search.'"';
