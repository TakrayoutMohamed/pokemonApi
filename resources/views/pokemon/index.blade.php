        ...
        <div class="row pt-2">
            @foreach ($pokemons['results'] as $pokemonId=>$pokemon)
                <div class="card-deck col-4 pb-4 text-center" >
                    <a href="detail/{{$pokemon->name}}" class="card col-12 box-shadow">
                        <div id="searchPokemonList">
                            <div class="card-header">
                                <h4 class="my-0 font-weight-normal">{{ $pokemon->name }}</h4>
                            </div>
                            <div class="card-body">
                                <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/{{ $pokemonId+1 }}.png" alt="...">
                            </div>
                        </div>
                    </a>
                </div>
